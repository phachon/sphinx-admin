 ...
 */
class CaptchaBuilder implements Captcha_Builder_Interface
{
    /**
     * @var array
     */
    ...
    public function __construct($phrase = null, Phrase_Builder_Interface $builder = null)
    {
        if ($builder === null) {
