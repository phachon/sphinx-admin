...
class Connection implements ConnectionInterface
{
    ...
    public function getConnection()
    {
        ...
        throw new Connection_Exception('The connection to the server has not been established yet.');
    }
    ...
    public function connect($suppress_error = false)
    {
        ...
        if ($conn->connect_error) {
            throw new Connection_Exception('Connection Error: ['.$conn->connect_errno.']'
                .$conn->connect_error);
        }
    ...
    public function query($query)
    {
        ...
        if ($this->getConnection()->error) {
            throw new Database_Exception('['.$this->getConnection()->errno.'] '.
    ...
    {
        if (count($queue) === 0) {
            throw new SphinxQL_Exception('The Queue is empty.');
        }
    ...
    public function escape($value)
    {
        ...
        if (($value = $this->getConnection()->real_escape_string((string) $value)) === false) {
            throw new Database_Exception($this->getConnection()->error, $this->getConnection()->errno);
        }
